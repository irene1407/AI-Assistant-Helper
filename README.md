...
### Enterprise Retrieval-Augmented Generation (RAG) System with Hybrid Search, Citation-Grounded Responses, and Local LLM Inference

<br>

<a href="#">
<img src="https://readme-typing-svg.demolab.com?font=Inter&weight=600&size=22&duration=3200&pause=900&color=6A5ACD&center=true&vCenter=true&width=900&lines=Enterprise+Retrieval-Augmented+Generation;Hybrid+Search+with+Semantic+%2B+Keyword+Retrieval;Citation-Grounded+Answers;Runs+100%25+Offline+using+Local+LLMs;Built+for+Production-Inspired+AI+Workflows" />
</a>
